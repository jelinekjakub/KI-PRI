...
<body class="bg-gray-100 p-6">
    <div class="max-w-3xl mx-auto bg-white p-8 shadow-lg rounded-lg">
        ...
        <form enctype="multipart/form-data" method="POST" class="space-y-4">
            ...
            <div class="flex items-center">
                <label class="w-32" for="xsd">XSD soubor:</label>
                <input type="file" name="xsd" data-max-file-size="2M" class="flex-1 border border-gray-300 p-2 rounded">
            </div>
        ...
        function validate($xmlPath, $dtdPath = '')
        {
            ...
            libxml_use_internal_errors(true);
            $isValid = $doc->schemaValidate($dtdPath);
            printErrors();
            libxml_use_internal_errors(false);
